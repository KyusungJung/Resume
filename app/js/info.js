        ...
        return (
            <div>
                <div className="profile-container" >
                    ...
                    < h3 className="tagline" > {profile.tag} </h3>
                </div>
                    ...
                    <ul className="list-unstyled contact-list" >
                        ...
                        {(profile.linkedin && profile.linkedin.length > 0) &&
                            <li className="linkedin" >
                                ...
                                <a href="#" target="_blank">{profile.linkedin}</a>
                            </li>
                        }
                        {(profile.github && profile.github.length > 0) &&
                            < li className="github" >
                                <i className="fa fa-github"> </i>
                                <a href={profile.github} target="_blank">Git Resume</a >
                            </li>
                        }
                        {
        ...
        return (
            <div>
                <div className="education-container container-block" >
                    ...
                    <ul className="list-unstyled interests-list" > {educations}</ul>
                </div>
                <div className="languages-container container-block" >
                    <h2 className="container-block-title">Languages</h2>
                    <ul className="list-unstyled interests-list" >{languages}</ul>
                </div>
                <div className="interests-container container-block">
                    <h2 className="container-block-title" > Interests </h2>
                    <ul className="list-unstyled interests-list" >{interests} </ul>
                </div>
            </div>
        );
    }
...
ReactDOM.render(
    <div>
        <DefaultProfile profile={userinfo.profile} />
        <AddonProfile educations={userinfo.educations}
